...
class AppConstants {
  static const String APP_NAME = 'السماك (المطعم)';
  static const double APP_VERSION = 1.0;

  static const String BASE_URL = 'https://elsmak.com';
  ...
  static const String net_by_search = '/api/v1/vendor/net_by_search';
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: Images.english, languageName: 'Urdu', countryCode: 'UR', languageCode: 'ur'),
