...
class AuthRepo {
  ...
  Future<Response> updateToken() async {
    ...
    var oldToken =  preferences.getString("oldToken");
    return await apiClient.postData(AppConstants.TOKEN_URI, {"_method": "put", "token": getUserToken(), "fcm_token": _deviceToken,"oldToken": oldToken});
  }
  ...
  Future<Response> netBySearch({String time}) async {
    return await apiClient.getData(AppConstants.net_by_search+time);
  }
  ...
  Future<bool> saveUserToken(String token, String zoneTopic) async {
    ...
    sharedPreferences.remove("oldToken");
    sharedPreferences.setString("oldToken", token);
